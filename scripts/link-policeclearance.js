// scripts/link-policeclearance.js
//
// Same pattern as link-hotspots.js / link-barangaycertification.js /
// link-barangayclearance.js — links each Police Clearance photo in
// Firebase Storage (making it public) and writes a matching document
// into the "documents" Firestore collection.
// Run with:
//   node scripts/link-policeclearance.js
//
// SETUP:
...
// "Documents/" folder, named exactly "Police-Clearance1.png" and
// "Police-Clearance2.png". If your actual Storage filenames differ,
...
const ENTRIES = [
  {
    ...
    photo: "Police-Clearance1.png",
    order: 1,
  },
  {
    name: "Police Clearance",
    photo: "Police-Clearance2.png",
    order: 2,
  },
];
