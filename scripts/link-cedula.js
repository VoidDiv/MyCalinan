// scripts/link-cedula.js
//
// Same pattern as link-hotspots.js / link-barangaycertification.js /
// link-barangayclearance.js / link-policeclearance.js — links each
// Cedula photo in Firebase Storage (making it public) and writes a
// matching document into the "documents" Firestore collection.
// Run with:
//   node scripts/link-cedula.js
//
// SETUP:
...
// "Documents/" folder, named exactly "Cedula1.png" and "Cedula2.png".
// If your actual Storage filenames differ, adjust the "photo" field
// per entry below to match exactly.
