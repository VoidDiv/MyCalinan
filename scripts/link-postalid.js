// scripts/link-postalid.js
//
// Same pattern as link-hotspots.js / link-barangaycertification.js /
// link-barangayclearance.js / link-policeclearance.js / link-cedula.js —
// links each Postal ID photo in Firebase Storage (making it public) and
// writes a matching document into the "documents" Firestore collection.
// Run with:
//   node scripts/link-postalid.js
//
// SETUP:
...
// "Documents/" folder, named exactly "Postal-ID1.png" and
// "Postal-ID2.png". If your actual Storage filenames differ, adjust
// the "photo" field per entry below to match exactly.
...
const ENTRIES = [
  {
    name: "Postal ID",
    photo: "Postal-ID1.png",
    order: 1,
  },
  {
    name: "Postal ID",
    photo: "Postal-ID2.png",
    order: 2,
  },
];
